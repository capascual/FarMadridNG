...
public class DistrictFragment extends Fragment {
    ...
    // TAG
    private static String TAG = DistrictFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_district, container, false);

        rv = (RecyclerView)rootView.findViewById(R.id.rv_districts);
        ...
        // Spinner
        spinner = (Spinner) rootView.findViewById(R.id.list_districts);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getActivity(),
                R.array.districts_array, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);

        button = (Button) rootView.findViewById(R.id.search_district);
    ...
    protected void startURLFetch(String urlS) {
        mTask = new URLFetchTask(this, URLFetchTask.FragmentType.DISTRICT);
        mTask.execute(urlS);
    }

    public void showProgressBar() {
        TextView tv = (TextView)getActivity().findViewById(R.id.titleDistrict);
        tv.setVisibility(View.GONE);
        Spinner spinner = (Spinner)getActivity().findViewById(R.id.list_districts);
        spinner.setVisibility(View.GONE);
        Button button = (Button)getActivity().findViewById(R.id.search_district);
        button.setVisibility(View.GONE);
        RecyclerView rv = (RecyclerView)getActivity().findViewById(R.id.rv_districts);
        rv.setVisibility(View.GONE);
        ProgressBar progress = (ProgressBar)getActivity().findViewById(R.id.progressBarDistrict);
